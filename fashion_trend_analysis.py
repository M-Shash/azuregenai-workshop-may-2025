...
deployment_name = "gpt-4-vision"  # Update this to match your deployed model name

# Path to local folder where fashion images are stored
image_folder = "fashion_images/images"  # Folder from downloaded Kaggle dataset
...
def analyze_image(filepath):
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a fashion trend analyst."
        },
        {
            "role": "user",
            "content": [
    ...
    response = openai.ChatCompletion.create(
        model=deployment_name,         # Use your deployment
        messages=messages,             # Include prompt and image
        max_tokens=1000                # Control the verbosity of the response
    )
